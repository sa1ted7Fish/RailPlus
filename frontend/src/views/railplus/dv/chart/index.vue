...
<script>
import { listChart, getChart, delChart, addChart, updateChart } from "@/api/railplus/dv/chart";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除Chart编号为"' + chartIds + '"的数据项？').then(function() {
